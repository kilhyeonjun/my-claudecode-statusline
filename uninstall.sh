...
for script in statusline-autopilot.sh statusline-burn.sh statusline-usage.sh statusline-lib.sh statusline-subagents.sh statusline-rate.sh statusline-model.sh statusline-line.sh; do
